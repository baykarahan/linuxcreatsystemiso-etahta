...
chroot chroot apt-get install zip unzip sudo ark p7zip file-roller --no-install-recommends -y
#chroot chroot apt-get install lsb-release systemsettings okular konsole -y

#Tab key parameters listing
chroot chroot apt-get install lsb-release systemsettings konsole bash-completion --no-install-recommends -y
